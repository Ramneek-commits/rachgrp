...
class LaneAnalysis:
    def __init__(self):
        ...
        self.experiment = "canny_10_100_normal"
    ...
    def image_callback(self, msg):
        ...
        if self.experiment == "canny_10_100":
            output = cv2.Canny(combined_mask, 10, 100)
        ...
        elif self.experiment == "hough_10":
            output = self.hough_experiment(cropped, combined_mask, 10)
        ...
        # =====================================
        ...
        elif self.experiment == "canny_10_100_normal":
            output = self.canny_from_lighting_image(cropped)

        elif self.experiment == "canny_10_100_dark":
            ...
            output = self.canny_from_lighting_image(dark_img)

        elif self.experiment == "canny_10_100_bright":
            bright_img = cv2.convertScaleAbs(
                cropped,
                alpha=1.3,
                beta=30
            )

            output = self.canny_from_lighting_image(bright_img)
