# parameters
ARG REPO_NAME="rachgrp"
ARG DESCRIPTION="Base class repo for UML EECE 5560"
ARG MAINTAINER="rach (s223927982@deakin.edu.au)"
...
RUN apt-key adv --keyserver 'hkp://keyserver.ubuntu.com:80' --recv-key C1CF6E31E6BADE8868D172B4F4ED6FBAB17C654
